        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTrustedMember = table.Column<bool>(type: "bit", nullable: false),
                    IsAdmin = table.Column<bool>(type: "bit", nullable: false),
                    FirstAddedToWatchlistAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExternalRatings_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsUserRated = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OmdbRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OmdbRatings_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TopMovies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TopMovies_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TopMovies_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstAddedToWatchlistAt", "FirstName", "IsAdmin", "IsTrustedMember", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "689289f7-5fb7-4763-ae24-dc1d7d7fc6eb", 0, "95b541e3-9362-46d6-bca2-052597e5cac2", "aamoviesapp@gmail.com", true, null, "Movies", true, true, "Admin", false, null, "AAMOVIESAPP@GMAIL.COM", "AAMOVIESAPP@GMAIL.COM", "AQAAAAIAAYagAAAAEIhMisoFWOoLKWtoXeprowUZAOW3vGqZCkYweBLVcXwDw41BQ545ZvB9GHLXepLa/A==", null, false, "b260ea5a-3dc9-47b6-8950-332c81e139dd", false, "aamoviesapp@gmail.com" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "1", "689289f7-5fb7-4763-ae24-dc1d7d7fc6eb" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalRatings_MovieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OmdbRatings_MovieId",
                table: "OmdbRatings",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_TopMovies_ApplicationUserId",
                table: "TopMovies",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TopMovies_MovieId",
                table: "TopMovies",
                column: "MovieId");
